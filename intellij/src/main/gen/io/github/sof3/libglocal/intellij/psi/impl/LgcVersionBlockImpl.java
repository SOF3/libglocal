...
public class LgcVersionBlockImpl extends ASTWrapperPsiElement implements LgcVersionBlock {

  public LgcVersionBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getVersionName() {
