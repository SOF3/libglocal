...
public class LgcVersionModifierImpl extends ASTWrapperPsiElement implements LgcVersionModifier {

  public LgcVersionModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitVersionModifier(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getModVersion() {
    return findNotNullChildByType(MOD_VERSION);
  }
