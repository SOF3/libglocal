...
public class LgcNumberAttributeValueImpl extends ASTWrapperPsiElement implements LgcNumberAttributeValue {

  public LgcNumberAttributeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitNumberAttributeValue(this);
  }
