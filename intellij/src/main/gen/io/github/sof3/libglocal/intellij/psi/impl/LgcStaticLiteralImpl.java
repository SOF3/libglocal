...
public class LgcStaticLiteralImpl extends ASTWrapperPsiElement implements LgcStaticLiteral {

  public LgcStaticLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitStaticLiteral(this);
  }
