...
public class LgcArgumentAttributeValueImpl extends ASTWrapperPsiElement implements LgcArgumentAttributeValue {

  public LgcArgumentAttributeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LgcVisitor visitor) {
    visitor.visitArgumentAttributeValue(this);
  }
