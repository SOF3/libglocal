...
public class LgcLangBlockImpl extends ASTWrapperPsiElement implements LgcLangBlock {

  public LgcLangBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
